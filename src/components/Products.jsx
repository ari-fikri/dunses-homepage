      ...
      <div className="products">
        <article className="card">
          ...
          <div className="card-footer">
            <a className="btn start-chat" href={createWhatsAppUrl('Special Tea')} target="_blank" rel="noopener noreferrer">
        ...
        <article className="card">
          ...
          <div className="card-footer">
            <a className="btn start-chat" href={createWhatsAppUrl('Green Tea')} target="_blank" rel="noopener noreferrer">
              <img src={waIco} alt="WhatsApp" className="wa-icon" />
              Start Chat
            </a>
          </div>
        ...
        <article className="card">
          ...
          <div className="card-footer">
            <a className="btn start-chat" href={createWhatsAppUrl('Black Tea')} target="_blank" rel="noopener noreferrer">
              <img src={waIco} alt="WhatsApp" className="wa-icon" />
              Start Chat
            </a>
          </div>
        ...
        <article className="card">
          ...
          <div className="card-footer">
            <a className="btn start-chat" href={createWhatsAppUrl('Blended Tea')} target="_blank" rel="noopener noreferrer">
              <img src={waIco} alt="WhatsApp" className="wa-icon" />
              Start Chat
            </a>
          </div>
